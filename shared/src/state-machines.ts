...
export const OT_STATE_TRANSITIONS: Record<OTState, OTState[]> = {
  SCHEDULED: ['PREPARING', 'PATIENT_READY', 'PATIENT_TRANSFER', 'PATIENT_ARRIVED', 'OT_READY', 'SURGERY_STARTED', 'DELAYED'],
  PREPARING: ['PATIENT_READY', 'PATIENT_TRANSFER', 'PATIENT_ARRIVED', 'OT_READY', 'SURGERY_STARTED', 'DELAYED'],
  PATIENT_READY: ['PATIENT_TRANSFER', 'PATIENT_ARRIVED', 'OT_READY', 'SURGERY_STARTED', 'DELAYED'],
  PATIENT_TRANSFER: ['PATIENT_ARRIVED', 'OT_READY', 'SURGERY_STARTED', 'DELAYED'],
  ...
  AVAILABLE: ['SCHEDULED', 'PREPARING', 'PATIENT_READY', 'PATIENT_TRANSFER', 'PATIENT_ARRIVED', 'OT_READY', 'SURGERY_STARTED'],
